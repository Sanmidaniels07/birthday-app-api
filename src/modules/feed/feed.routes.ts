...
feedRouter.get(
  "/by/:username/reposts",
  validate({ params: usernameParam, query: feedQuerySchema }),
  controller.byAuthorReposts,
);
feedRouter.get(
  "/by/:username",
  validate({ params: usernameParam, query: feedQuerySchema }),
...
feedRouter.post(
  ...
  interactionLimiter,
  validate({ params: postIdParam, body: reactionSchema }),
  controller.react,
);
feedRouter.get(
  "/posts/:postId/reactions",
...
feedRouter.post(
  ...
  interactionLimiter,
  validate({ params: postIdParam, body: addCommentSchema }),
  controller.comment,
);
feedRouter.get(
  "/posts/:postId/comments",
  validate({ params: postIdParam, query: feedQuerySchema }),
  controller.comments,
);
feedRouter.delete(
  "/comments/:commentId",
